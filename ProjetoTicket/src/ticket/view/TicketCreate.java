 ...
 */
public class TicketCreate extends javax.swing.JFrame {
    ...
    private void btnEnviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarActionPerformed
        ...
        this.chamado.gerarId();
        JOptionPane.showMessageDialog(null, "Código de registro: #" + this.chamado.getId(), "Chamado registrado", JOptionPane.INFORMATION_MESSAGE, null);
        
        this.chamado.setNome(txtNome.getText());
